...
* NerdGraph requires a New Relic <InlinePopover type="userKey" />: this can be generated and accessed from the [GraphiQL explorer](#explorer).
...
## Use the NerdGraph explorer [#explorer]

You can use our NerdGraph explorer to explore the NerdGraph schema and to make API calls:

* US data center: [https://api.newrelic.com/graphql](https://api.newrelic.com/graphql)
* EU data center: [https://api.eu.newrelic.com/graphql](https://api.eu.newrelic.com/graphql)

For tips on using the explorer, see [NerdGraph explorer tutorial](/docs/apis/nerdgraph/get-started/nerdgraph-explorer).
...
* For applied intelligence: [Configuring topology for incident correlation](/docs/apis/nerdgraph/examples/topology-nerdgraph-tutorial)
    ...
    <tr>
      ...
      <td>
        ...
        * [Examples of configuring mobile monitoring](/docs/apis/nerdgraph/examples/mobile-monitoring-config-nerdgraph/#configure-mobile-application)
      </td>
    </tr>
