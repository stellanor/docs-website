...
* NerdGraph requires a New Relic <InlinePopover type="userKey" />: this can be generated and accessed from the [
...
* US data center: [https://api.newrelic.com/graphiql](https://api.newrelic.com/graphiql)
* EU data center: [https://api.eu.newrelic.com/graphiql](https://api.eu.newrelic.com/graphiql)
